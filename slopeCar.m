...
car_angle=pi/3; slope_long=40*stick_long; slope_bias=(4/5)*stick_long;
...
for i=1:N
    ...
    y_pos=x(i,7);
    printCar(x_pos,y_pos,stick_long,angle,car_angle);
    axis([-15*stick_long 1*stick_long -15*stick_long 1*stick_long]);axis('equal');
